 ...
 <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> {{ systemSetting()?->organization_name }}
              </h3>
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Course <i class="mdi mdi-chart-line mdi-24px float-end"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Student <i class="mdi mdi-bookmark-outline mdi-24px float-end"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Teacher<i class="mdi mdi-diamond mdi-24px float-end"></i>
                    </h4>
                    <h2 class="mb-5">{{ $teacherCount}}</h2>
                  </div>
                </div>
              </div>
            </div>
