        ...
        <div class="page-header">
            <h3 class="page-title">
                <a href="{{ route('admin.introduction.index') }}">
                    ...
                    </span> </a> Introduction Create Page
            </h3>
        ...
        <div class="container p-5 bg-white">
            ...
            <form action="{{ route('admin.introduction.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  name="mission" id="exampleInputImage1" aria-describedby="imageHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputImage1" class="form-label">Vission</label>
                    <input type="text" class="form-control"  name="vision" id="exampleInputImage1" aria-describedby="imageHelp">
                </div>
