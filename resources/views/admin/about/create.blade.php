        ...
        <div class="container p-5 bg-white">
            ...
            <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="employment_rate" id="exampleEmploymentRate1"
                        aria-describedby="employmentRateHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputStudentRatio1" class="form-label">Student Ratio</label>
                    <input type="text" class="form-control" name="student_ratio" id="exampleInputStudentRatio1"
                        aria-describedby="studentRatioHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputProgramOffer1" class="form-label">Program Offer</label>
                    <input type="text" class="form-control" name="program_offer" id="exampleInputProgramOffer1"
                        aria-describedby="programOfferHelp">
                </div>
                <div class="mb-3">
